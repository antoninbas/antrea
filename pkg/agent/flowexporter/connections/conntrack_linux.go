...
func NewConnTrackSystem(nodeConfig *config.NodeConfig, nodeStore *k8s.NodeStore, serviceCIDRv4 netip.Prefix, serviceCIDRv6 netip.Prefix, isAntreaProxyEnabled bool) *connTrackSystem {
